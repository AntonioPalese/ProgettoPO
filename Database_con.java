...
public class Database_con {
	...
	public Database_con(){
		...
		try { 
			cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Hotel_database?user=root&password=4shbkmiswllvw7e"); 
	...
	public Connection createConnection(){ 
		...
		try { 
			this.cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Hotel_database?user=root&password=4shbkmiswllvw7e");
		} catch (SQLException e) { 
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
